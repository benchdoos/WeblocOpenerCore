...
public class AppearanceSetterPanel extends JPanel implements SettingsPanel, Translatable {
    ...
    private void $$$setupUI$$$() {
        ...
        this.$$$loadLabelText$$$(darkModeLabel, this.$$$getMessageFromBundle$$$("translations/AppearanceSetterPanelBundle", "darkMode"));
        ...
        this.$$$loadLabelText$$$(label1, this.$$$getMessageFromBundle$$$("translations/AppearanceSetterPanelBundle", "beginning"));
        ...
        this.$$$loadLabelText$$$(label2, this.$$$getMessageFromBundle$$$("translations/AppearanceSetterPanelBundle", "ending"));
        ...
        this.$$$loadButtonText$$$(disabledDarkModeRadioButton, this.$$$getMessageFromBundle$$$("translations/AppearanceSetterPanelBundle", "disabledName"));
        ...
        this.$$$loadButtonText$$$(byTimeDarkModeRadioButton, this.$$$getMessageFromBundle$$$("translations/AppearanceSetterPanelBundle", "byTimeName"));
        ...
        this.$$$loadButtonText$$$(alwaysDarkModeRadioButton, this.$$$getMessageFromBundle$$$("translations/AppearanceSetterPanelBundle", "alwaysName"));
        ...
        this.$$$loadButtonText$$$(byLocationDarkModeRadioButton, this.$$$getMessageFromBundle$$$("translations/AppearanceSetterPanelBundle", "byLocationName"));
