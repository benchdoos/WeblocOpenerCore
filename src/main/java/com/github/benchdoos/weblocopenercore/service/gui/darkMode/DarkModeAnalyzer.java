...
import com.github.benchdoos.weblocopenercore.model.darkMode.DarkModeValue;
...
public class DarkModeAnalyzer {
    ...
    private static Location getLocation(String value) {
        ...
        double longitude = Double.parseDouble(locationSplit[0]);
        double latitude = Double.parseDouble(locationSplit[1]);
